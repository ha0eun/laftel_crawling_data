...
from keras_preprocessing.sequence import pad_sequences   # pip install tensorflow==2.9.1
...
df = pd.read_csv('./crawling_data/laftel_crawling_data_20221129.csv')
print(df.head(10))
...
np.save('./models/laftel_titles_data_max_{}_wordsize_{}.npy'.format(max_len, wordsize), xy)      # xy에 저장
